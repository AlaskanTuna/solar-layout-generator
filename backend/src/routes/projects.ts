...
projectsRouter.patch('/:id/layout', requireAuth, validate(saveLayoutSchema), async (req, res) => {
...
projectsRouter.patch('/:id/analysis', requireAuth, validate(saveAnalysisSchema), async (req, res) => {
